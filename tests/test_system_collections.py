...
class TestSystemCollections(unittest.TestCase):
    ...
    def test_box_configuration(self):
        box_id = 'box_1'
        process_list = {
            'process_1': {box_configuration.IS_ON: box_configuration.STATE_ON,
                          box_configuration.PID: 1001},
            'process_2': {box_configuration.IS_ON: box_configuration.STATE_ON,
                          box_configuration.PID: 1001},
            'process_3': {box_configuration.IS_ON: box_configuration.STATE_ON,
                          box_configuration.PID: 1001},
        }
